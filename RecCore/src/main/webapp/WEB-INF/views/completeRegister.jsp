...
<spring:url value="/resources/assets/js/completeRegister.js" var="complete_register_js"/>
<spring:url value="/login" var="login"/>
<spring:url value="/registerSocial" var="register"/>
<spring:url value="/v1/utilities/email_exist/" var="emailVerify"/>
<spring:url value="/v1/utilities/user_exist/" var="usernameVerify"/>
...
<head>
    ...
    <script type="text/javascript" src="${complete_register_js}"></script>
    ...
    <div class="span12" style="margin: 0; float: left;">
        ...
        <div class="mainFormBox">
            ...
            <div class="formBox box">
                <h2 class="formTittle">Completar Registro</h2>

                <form:form id="registerForm" action="${register}" commandName="user">
                    <form:hidden path="id"/>
                    <fieldset>
                        ...
                        <button id="completeRegister" type="button" onclick="sendForm()" class="button">Registrarse</button>
                    </fieldset>
                </form:form>
                <input id="emailVerifyUrl" type="hidden" value="${emailVerify}"/>
                <input id="usernameVerifyUrl" type="hidden" value="${usernameVerify}"/>
                <input id="usernameOld" type="hidden" value="${usernameOld}"/>
            </div>
            <p class="termsPolicyText">
                Haciendo click en el botón, aceptas los <a id="signup_terms" href="#">Términos
                de Uso</a> y la <a id="signup_privacy" href="#">Política de
                Privacidad</a> de Recomendar.
            </p>
            <script>
