/**
 * Project: RecCommon
 * Created by: raulanatol at 05/12/13 13:55
...
public enum MimeType {
    ...
    public static MimeType fromString(String contentType) {
        MimeType result = UNKNOWN;
        if (!StringHelper.isEmpty(contentType)) {
            for (MimeType mime : values()) {
                if (StringHelper.equals(mime.contentType, contentType)) {
                    result = mime;
                    break;
                }
            }
