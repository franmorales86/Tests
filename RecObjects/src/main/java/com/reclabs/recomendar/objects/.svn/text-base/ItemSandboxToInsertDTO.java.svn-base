/**
 * Project: RecObjects
 * Created by: raulanatol at 26/03/2013 11:38:07
 ...
 * @author raulanatol
 */
public class ItemSandboxToInsertDTO {
    /**
     * Nombre del item.
     */
    private String name;
    ...
    public String toString() {
        return "ItemSandboxToInsertDTO [name=" + name + ", description=" + description + ", imagesURL=" + imagesURL + ", ean=" + ean + ", isbn=" + isbn + ", tags=" + tags + ", shopId=" + shopId + ", price=" + price + "]";
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        ItemSandboxToInsertDTO other = (ItemSandboxToInsertDTO) obj;
        if (description == null) {
